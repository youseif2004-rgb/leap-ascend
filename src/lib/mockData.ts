import { Brain, Workflow, Bot, Cloud, LineChart, Sparkles, type LucideIcon } from "lucide-react";
...
export const services: Service[] = [
  {
    ...
    description:
      "Map where intelligence creates leverage in your business — then build the roadmap to capture it.",
    includes: [
      "Opportunity audit",
      "Roadmap & ROI model",
      "Architecture review",
  ...
  },
  {
    ...
    description:
      "Replace manual, repetitive work with adaptive workflows that learn, decide, and scale with you.",
    includes: [
      "Process discovery",
  ...
  },
  {
    ...
    description:
      "Domain-trained agents that operate inside your tools — sales, support, ops — quietly compounding output.",
  ...
  },
  {
    ...
    description:
      "From zero-to-one to scale-up — premium product builds with the polish of a top-tier studio.",
  ...
  },
  {
    ...
    description:
      "Turn raw data into the operating system of your decisions — clean pipelines, sharp dashboards.",
  ...
  },
  {
    ...
    description:
      "Ship customer-facing AI experiences that feel native, fast, and unmistakably premium.",
...
export const projects: Project[] = [
  {
    ...
    category: "Web",
    blurb:
      "AI-powered perfume recommendation system that matches users to luxury scents through a personalized quiz and preference learning.",
    image: "/images/pluto-fragrance.png",
    tags: ["AI Recommendation", "E-Commerce", "Luxury"],
    url: "https://perfume-pluto.vercel.app",
  },
  {
    title: "LEAP Property Match",
    client: "LEAP (Concept Demo)",
    category: "AI",
    blurb:
  ...
  },
  {
    ...
    category: "Web",
    blurb:
      "Cutting-edge dental clinic website with online appointment booking and phone-based management dashboard for Shorouk City practice.",
...
export const testimonials = [
  {
    quote:
      "LEAP didn't just ship software — they rewired how our operation thinks. Six months in, the numbers don't lie.",
    name: "Sara Mansour",
    role: "COO, Helix Logistics",
  },
  {
    quote:
      "The polish is Silicon Valley. The partnership is family. That combination is rare and very real.",
    name: "Daniel Park",
    role: "Founder, Aurora Financial",
  },
  {
    quote:
      "We replaced three vendors with LEAP and moved twice as fast. Their AI work is genuinely state of the art.",
    name: "Lina Chen",
    role: "VP Product, Nexus Retail",
  },
  {
    quote:
      "From day one it felt like they were on our cap table. Vision-aligned, technically elite, beautifully calm.",
    name: "Marc Adler",
...
export const timeline = [
  {
    year: "2015",
    title: "LEAP founded in Cairo",
    body: "Three engineers, one obsession: premium software for ambitious companies.",
  },
  {
    year: "2018",
    title: "First AI practice",
    body: "Production ML systems for healthcare and logistics — quietly, no theater.",
  },
  {
    year: "2021",
    title: "Scaled to MENA & EU",
    body: "Embedded teams across 12 countries. The bar kept rising.",
  },
  {
    year: "2024",
    title: "Agentic systems era",
    body: "Custom agents inside the workflows of category-defining companies.",
  },
  {
    year: "2026",
    title: "Where ambition takes flight",
    body: "200+ projects. 80+ partners. One promise — turn momentum into altitude.",
  },
];
...
export const faqs = [
  {
    ...
    a: "Most engagements kick off within 7–10 days of signing. Our bench is intentionally kept warm for partners.",
  },
  {
    q: "Do you replace or augment our team?",
    a: "Either, both, neither. We embed where it accelerates you — and step back where you're stronger.",
  },
  {
    q: "What does ‘AI partner' actually mean here?",
    a: "It means we own outcomes, not tickets. Strategy, build, operate — end to end, with a single accountable team.",
  },
  {
    q: "Is everything covered by the plan?",
    a: "Plans cover ongoing partnership and delivery. Bespoke hardware, third-party licenses, and large-scale infra are billed transparently at cost.",
  },
  {
    q: "Can we move plans?",
    a: "Anytime, in either direction, no penalties. Many partners begin on Gold and graduate to Premium within two quarters.",
  },
];
